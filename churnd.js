...
Churnd.prototype.login = function (email_id, account_name) {
    ...
    xhr.open("POST", "http://vast-savannah-8474.herokuapp.com/api/login");
...
Churnd.prototype.track = function (email_id, interaction_type, account_name) {
    ...
    xmlhttp.open("POST", "http://vast-savannah-8474.herokuapp.com/api/track");
...
Churnd.prototype.logout = function(email_id, account_name) {
    ...
    var xmlhttp = new XMLHttpRequest();   // new HttpRequest instance 
    xmlhttp.open("POST", "http://vast-savannah-8474.herokuapp.com/api/logout");
    xmlhttp.setRequestHeader("Content-Type", "application/json;charset=UTF-8");
    xmlhttp.send(JSON.stringify(sendData));
